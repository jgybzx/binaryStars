...
public class DateUtil {
     ...
     * 得到某个日期范围的上期
     * 比如 2021-01 ~ 2021-12
     * 则上期日期为 2020-01~2020-12
     *
     * @return
     */
    public static void getLastDate(Map<String, Object> map) {
        String startDate = (String) map.get("startDate");
        String endDate = (String) map.get("endDate");
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM");
        Calendar instance = Calendar.getInstance();
        try {
            instance.setTime(dateFormat.parse(startDate));
            instance.add(Calendar.YEAR, -1);
            String startDateLast = dateFormat.format(instance.getTime());
            instance.setTime(dateFormat.parse(endDate));
            instance.add(Calendar.YEAR, -1);
            String endDateLast = dateFormat.format(instance.getTime());
            map.put("startDateLast", startDateLast);
            map.put("endDateLast", endDateLast);
        } catch (ParseException e) {
            e.printStackTrace();
        }
    }
